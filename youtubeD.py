...
def createWidgets():
    ...
    #path button
    browse_button = Button(root, text="Where to?", command=browse, width=10, bg="#93BCF4")
    browse_button.grid(row=2, column=2, pady=1, padx=1)
    
    #download button
    down_button = Button(root, text="Get it!", command=download_video, width=25, bg="#8ACE8C")
...
root.title("YouTube Downloader by HolyGenius")
